/**
 * Use Sorting to do it in O(nLogn) time.
 * Hashing can also be used as it has a worst-case time complexity of O(n) but requires space.
 *
 * Here, in this approach we are going to use bitwise operators for a solution that is O(n). 
*/
#include <iostream>
